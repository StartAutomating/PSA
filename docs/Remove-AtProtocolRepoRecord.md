...
### Syntax
```PowerShell
Remove-AtProtoRepoRecord [[-Repo] <String>] [[-Collection] <String>] [[-Rkey] <String>] [[-SwapRecord] <String>] [[-SwapCommit] <String>] [-Authorization] [-Raw] [-WhatIf] [-Confirm] [<CommonParameters>]
```
