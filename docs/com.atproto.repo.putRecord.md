...
### Syntax
```PowerShell
Set-AtProtoRepoRecord [[-Repo] <String>] [[-Collection] <String>] [[-Rkey] <String>] [-Validate] [[-Record] <PSObject>] [[-SwapRecord] <String>] [[-SwapCommit] <String>] [-Raw] [-WhatIf] [-Confirm] [<CommonParameters>]
```
