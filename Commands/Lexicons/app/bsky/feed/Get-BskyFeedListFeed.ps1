...
.Description
    app.bsky.feed.getListFeed
.Link
    https://github.com/bluesky-social/atproto/tree/main/lexicons/app/bsky/feed/getListFeed.json
#>
...
begin {
$NamespaceID = 'app.bsky.feed.getListFeed'
$httpMethod  = 'GET'
