...
.Description
    app.bsky.feed.getQuotes
.Link
    https://github.com/bluesky-social/atproto/tree/main/lexicons/app/bsky/feed/getQuotes.json
#>
[Alias('Get-BlueSkyFeedQuotes','bsky.feed.getQuotes','app.bsky.feed.getQuotes')]
...
begin {
$NamespaceID = 'app.bsky.feed.getQuotes'
$httpMethod  = 'GET'
