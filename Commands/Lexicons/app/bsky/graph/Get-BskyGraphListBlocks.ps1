function Get-BskyGraphListBlocks  {
<#
.Synopsis
...
.Description
    app.bsky.graph.getListBlocks
.Link
    https://github.com/bluesky-social/atproto/tree/main/lexicons/app/bsky/graph/getListBlocks.json
#>
[Alias('Get-BlueSkyGraphListBlocks','bsky.graph.getListBlocks','app.bsky.graph.getListBlocks')]
...
begin {
$NamespaceID = 'app.bsky.graph.getListBlocks'
$httpMethod  = 'GET'
