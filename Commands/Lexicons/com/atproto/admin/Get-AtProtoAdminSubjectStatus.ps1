function Get-AtProtoAdminSubjectStatus  {
<#
.Synopsis
...
.Description
    com.atproto.admin.getSubjectStatus
.Link
    https://github.com/bluesky-social/atproto/tree/main/lexicons/com/atproto/admin/getSubjectStatus.json
#>
[Alias('Get-AtProtocolAdminSubjectStatus','atproto.admin.getSubjectStatus','com.atproto.admin.getSubjectStatus')]
...
$Uri,
[Parameter(ValueFromPipelineByPropertyName)]
[ComponentModel.DefaultBindingProperty('blob')]
[String]
$Blob,
...
begin {
$NamespaceID = 'com.atproto.admin.getSubjectStatus'
$httpMethod  = 'GET'
