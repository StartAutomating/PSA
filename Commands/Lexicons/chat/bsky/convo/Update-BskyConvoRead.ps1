...
.Description
    chat.bsky.convo.updateRead
.Link
    https://github.com/bluesky-social/atproto/tree/main/lexicons/chat/bsky/convo/updateRead.json
#>
[Alias('Update-BlueSkyConvoRead','bsky.convo.updateRead','chat.bsky.convo.updateRead')]
...
begin {
$NamespaceID = 'chat.bsky.convo.updateRead'
$httpMethod  = 'POST'
