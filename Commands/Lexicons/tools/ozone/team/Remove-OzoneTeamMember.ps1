function Remove-OzoneTeamMember  {
<#
.Synopsis
...
.Description
    tools.ozone.team.deleteMember
.Link
    https://github.com/bluesky-social/atproto/tree/main/lexicons/tools/ozone/team/deleteMember.json
#>
[Alias('ozone.team.deleteMember','tools.ozone.team.deleteMember')]
...
begin {
$NamespaceID = 'tools.ozone.team.deleteMember'
$httpMethod  = 'POST'
