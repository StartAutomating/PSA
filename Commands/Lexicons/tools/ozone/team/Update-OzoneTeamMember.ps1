function Update-OzoneTeamMember  {
<#
.Synopsis
...
.Description
    tools.ozone.team.updateMember
.Link
    https://github.com/bluesky-social/atproto/tree/main/lexicons/tools/ozone/team/updateMember.json
#>
[Alias('ozone.team.updateMember','tools.ozone.team.updateMember')]
...
$Disabled,
[Parameter(ValueFromPipelineByPropertyName)]
[ComponentModel.DefaultBindingProperty('role')]
[String]
$Role,
...
begin {
$NamespaceID = 'tools.ozone.team.updateMember'
$httpMethod  = 'POST'
