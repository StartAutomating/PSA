function Get-OzoneModerationRepo  {
<#
.Synopsis
...
.Description
    tools.ozone.moderation.getRepo
.Link
    https://github.com/bluesky-social/atproto/tree/main/lexicons/tools/ozone/moderation/getRepo.json
#>
[Alias('ozone.moderation.getRepo','tools.ozone.moderation.getRepo')]
...
begin {
$NamespaceID = 'tools.ozone.moderation.getRepo'
$httpMethod  = 'GET'
